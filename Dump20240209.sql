...
CREATE TABLE `expired_products` (
  ...
  CONSTRAINT `expired_products_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `expired_products` VALUES (1,'Sugar - Brown','2022-10-30 21:58:50'),(2,'Tea - Herbal I Love Lemon','2022-05-04 05:33:53'),(3,'Cloves - Ground','2023-03-26 07:57:03'),(4,'Trout - Rainbow, Frozen','2021-07-06 11:54:31'),(5,'Lychee','2021-12-14 13:57:23'),(6,'Yogurt - Strawberry, 175 Gr','2021-02-04 17:10:18'),(7,'Dates','2021-03-15 05:30:40'),(8,'Potatoes - Fingerling 4 Oz','2023-08-18 03:53:20'),(9,'Pork - Sausage, Medium','2023-06-08 02:06:04'),(10,'Chicken Giblets','2022-01-15 23:19:44');
...
INSERT INTO `payments` VALUES (1,'maestro',40.01,1),(2,'jcb',56.67,2),(3,'diners-club-enroute',72.84,3),(4,'jcb',30.33,4),(5,'china-unionpay',66.84,5),(6,'visa-electron',77.79,6),(7,'jcb',47.14,7),(8,'jcb',15.81,8),(9,'diners-club-carte-blanche',88.60,9),(10,'visa',31.98,10),(11,'jcb',16.44,11),(12,'diners-club-enroute',21.02,12),(13,'jcb',27.92,13),(14,'mastercard',51.04,14),(15,'visa',46.66,15),(16,'diners-club-enroute',44.49,16),(17,'jcb',24.45,17),(18,'mastercard',34.83,18),(19,'jcb',30.27,19),(20,'china-unionpay',85.42,20),(21,'visa-electron',37.04,21),(22,'solo',67.41,22),(23,'mastercard',45.35,23),(24,'jcb',17.58,24),(25,'jcb',67.63,25);
...
-- Dump completed on 2024-02-09  3:34:47
